...
/**
 * Singleton container for shared PostgreSQL testcontainer across all E2E tests.
 * 
 * This ensures that all E2E test classes share a single PostgreSQL container,
 ...
 * database cleanup via TRUNCATE in each test's @BeforeEach method.
 */
